...
- **NEB**: Contains the NEB calculation results.  
  - **00** and **08** correspond to the first and last images mentioned above.  
  - You should be able to find out the detailed calculation logs for the middile images from **01–07**, including initial guess pathway(from POSCARs). 

---

## Methods Overview  

- Calculation type is NEB.
- A total of 7 images are used.
- NEB force threshold is set to 0.02 eV/Å.
